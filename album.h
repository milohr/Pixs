...
public:
    ...
    ~Album(){}
    void createAlbumx(QString imagePath,PixsUtils::ALbumSizeHint widgetSize,int widgetRadius, bool isDraggable);
    void createAlbum(const QString &artist, const QString &album, const QString &imagePath, const PixsUtils::ALbumSizeHint &widgetSize, const int &widgetRadius=0, const bool &isDraggable=false);
